...
public class MapImmutablePropertiesTest {
  ...
  public void testImmutableProperties() throws IncompleteException {
    ImmutableProperties props1 = new MapImmutableProperties.Builder()
        .withProperty("key1", "Hello World")
        .withProperty("key2", 17)
        .save();
    testMap(props1.getAll());

    ImmutableProperties props2 = new MapImmutableProperties.Builder()
        .withProperty("key3",
    ...
    ImmutableProperties props3 = new MapImmutableProperties.Builder()
        .withProperty("key3",

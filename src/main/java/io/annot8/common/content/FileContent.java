...
// File is nice and easy, but isn't helptful for thing like
// 'path to file in zip'. This could be Content<URL> or perhaps smething more
// abstract like Content<InputStream> with properties for mime, etc.
// Since we just want this to drop into sometihng like TikaProcessor (FileContent -> Text)
...
// we could havea FileContent extends InputStreamProvider, Content<File>
